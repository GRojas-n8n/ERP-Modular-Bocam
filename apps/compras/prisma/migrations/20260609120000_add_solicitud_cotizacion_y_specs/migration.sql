...
-- Especificaciones tecnicas por partida de requisicion
...
CREATE INDEX "especificaciones_detalle_req_tenant_id_detalle_id_idx"
    ON "especificaciones_detalle_req"("tenant_id", "detalle_id");
...
CREATE UNIQUE INDEX "solicitudes_cotizacion_tenant_id_requisicion_id_key"
    ON "solicitudes_cotizacion"("tenant_id", "requisicion_id");

CREATE INDEX "solicitudes_cotizacion_tenant_id_proyecto_id_idx"
    ON "solicitudes_cotizacion"("tenant_id", "proyecto_id");

-- Proveedores por solicitud de cotizacion
CREATE TABLE "solicitudes_cotizacion_proveedores" (
    ...
    CONSTRAINT "solicitudes_cotizacion_proveedores_solicitud_id_fkey"
        ...
        REFERENCES "solicitudes_cotizacion"("id_solicitud")
        ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE UNIQUE INDEX "solicitudes_cotizacion_proveedores_solicitud_id_proveedor_id_key"
    ON "solicitudes_cotizacion_proveedores"("solicitud_id", "proveedor_id");

CREATE INDEX "solicitudes_cotizacion_proveedores_tenant_id_solicitud_id_idx"
    ON "solicitudes_cotizacion_proveedores"("tenant_id", "solicitud_id");

-- Anotaciones por especificacion x proveedor en el cuadro comparativo
