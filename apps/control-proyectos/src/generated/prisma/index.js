...
const config = {
  ...
  "inlineSchemaHash": "b55d86860f5d55df485a93464dbd306f6caca3e706266c900c74615084c63421",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "apps/control-proyectos/src/generated/prisma",
    "control-proyectos/src/generated/prisma",
  ]
...
path.join(process.cwd(), "apps/control-proyectos/src/generated/prisma/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "apps/control-proyectos/src/generated/prisma/schema.prisma")
