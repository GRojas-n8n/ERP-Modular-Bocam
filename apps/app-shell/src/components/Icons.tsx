...
/**
 * 🎨 BOCAM ERP - Safe Icon System
 * Icons implemented as direct SVGs to ensure stability in React 19 environments.
 */
...
export const IconSettings = ({ className }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12.22 2h-.44a2 2 0 0 0-1.78 1.4L9.5 5.5l-1.42.42-3.46-2.1a2 2 0 0 0-2.3 0C1.5 4.5 1 5.4 1 6.4a2 2 0 0 0 .82 1.62l2.48 2.5a2 2 0 0 0-.42 1.42v1.44a2 2 0 0 0 .42 1.42l-2.48 2.5a2 2 0 0 0-.82 1.62 2 2 0 0 0 .82 1.62 2 2 0 0 0 2.3 0l3.46-2.1 1.42.42.5 2.1a2 2 0 0 0 1.78 1.4h.44a2 2 0 0 0 1.78-1.4l.5-2.1 1.42-.42 3.46 2.1a2 2 0 0 0 2.3 0c.82-.68 1.32-1.58 1.32-2.58a2 2 0 0 0-.82-1.62l-2.48-2.5a2 2 0 0 0 .42-1.42v-1.44a2 2 0 0 0-.42-1.42l2.48-2.5a2 2 0 0 0 .82-1.62 2 2 0 0 0-.82-1.62 2 2 0 0 0-2.3 0l-3.46 2.1-1.42-.42-.5-2.1a2 2 0 0 0-1.78-1.4Z"/><circle cx="12" cy="12" r="3"/>
  </svg>
);
...
export const IconCheckCircle2 = ({ className }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const IconLayers = ({ className }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <polygon points="12 2 2 7 12 12 22 7 12 2"/><polygon points="2 12 12 17 22 12"/><polygon points="2 17 12 22 22 17"/>
  </svg>
);
...
export const IconRefreshCw = ({ className }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const IconFileCheck = ({ className }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const IconTrash2 = ({ className }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
