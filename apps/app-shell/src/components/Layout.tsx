...
export const ALL_NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    roles: ['procurement', 'residencia', 'gerencia_tecnica', 'superintendent'],
    subItems: [
      { id: 'requisiciones',   label: 'Requisiciones', icon: IconShoppingCart, roles: ['procurement', 'superintendent'] },
      { id: 'catalogo',        label: 'Catálogo',       icon: IconPackage,      roles: ['procurement', 'superintendent'] },
      { id: 'proveedores',     label: 'Proveedores',    icon: IconUsers,        roles: ['procurement', 'superintendent'] },
      { id: 'pendientes-eval', label: 'Eval. Técnica',  icon: IconClock,        roles: ['residencia', 'superintendent'] },
      { id: 'pendientes-gt',   label: 'Aprob. GT',      icon: IconCheckCircle2, roles: ['gerencia_tecnica', 'superintendent'] },
      { id: 'ordenes-compra',  label: 'Órdenes de Compra', icon: IconSend,      roles: ['procurement', 'superintendent'] },
      { id: 'trazabilidad',    label: 'Trazabilidad',   icon: IconScale,        roles: ['procurement', 'superintendent', 'gerencia_tecnica'] },
      { id: 'admin-purga',     label: 'Herramientas Admin', icon: IconTrash2,   roles: ['admin'] },
    ],
  },
  {
  ...
  {
    name: 'Control de Obra', icon: IconActivity, id: 'control-obra',
    roles: ['control_obra', 'control_proyectos', 'director'],
    subItems: [
      { id: 'dashboard',     label: 'Dashboard EVM',    icon: IconActivity },
              ...
              <div className="relative min-w-0 flex-1">
                ...
                >
                  ...
                  <span className="flex min-w-0 flex-1 flex-col items-center">
                    <span className="w-full truncate text-center text-xs font-bold">{currentProject?.name || 'Sin Proyecto'}</span>
                    {currentProject?.code && (
                      <span className="w-full truncate text-center text-[9px] font-black uppercase tracking-widest opacity-70">
                        {currentProject.code}
                      </span>
                    )}
                  </span>
