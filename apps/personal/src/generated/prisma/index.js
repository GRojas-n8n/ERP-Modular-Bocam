...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "apps/personal/src/generated/prisma",
    "personal/src/generated/prisma",
  ]
...
path.join(process.cwd(), "apps/personal/src/generated/prisma/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "apps/personal/src/generated/prisma/schema.prisma")
