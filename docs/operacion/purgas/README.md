...
Cada ejecución real de `scripts/ops/purga-proyecto/purga-proyecto-multidb.sh --ejecutar` escribe aquí un archivo `AAAAMMDD-HHMMSS-purga-multidb.md` con:

- Fecha (UTC), operador y tenant.
- **Códigos de Centro de Costos** purgados.
- Nombre y **SHA-256** del respaldo previo.
- Bases procesadas y filas eliminadas por base y tabla.
