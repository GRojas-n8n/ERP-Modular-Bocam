# control-acceso-modulo-finanzas Specification

## Purpose

Las acciones restringidas del módulo Finanzas (crear presupuesto,
registrar movimiento, transferir presupuesto, programar pagos y marcar un
pago como pagado) verifican el rol real `'finanzas'` (español) asignado a
los usuarios de Finanzas del sistema, no un nombre en inglés inexistente.
