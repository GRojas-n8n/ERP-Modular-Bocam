# eliminacion-importaciones-admin-gt Specification

## Purpose
Permite a Administración, Gerencia Técnica y Control de Proyectos deshacer importaciones hechas por error en Gerencia Técnica (Catálogo de Conceptos, lotes de Explosión de Insumos y Composición APU), con rechazo cuando los datos ya están en uso.
## Requirements
