# control-acceso-rol-finanzas-compras Specification

## Purpose

Los endpoints de solo lectura de órdenes de compra y proveedores en el microservicio `compras` verifican el rol real `'finanzas'` (español) asignado a los usuarios de Finanzas del sistema, no un nombre en inglés inexistente.
