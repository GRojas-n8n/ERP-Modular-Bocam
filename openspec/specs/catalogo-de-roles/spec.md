# catalogo-de-roles Specification

## Purpose

Fuente única de verdad de los roles del sistema: un catálogo compartido, sin
dependencias, importable tanto por los microservicios Express como por el
bundle del navegador. Garantiza que todo rol exigido por el backend pueda
asignarse desde Administración, y que el alta de usuarios rechace roles no
reconocidos.
...
Cuando un rol está catalogado pero ningún servicio lo comprueba todavía, la interfaz de alta de usuarios SHALL indicarlo al seleccionarlo, para que el
