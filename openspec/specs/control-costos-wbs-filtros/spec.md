# control-costos-wbs-filtros Specification

## Purpose
Define qué filtros ofrece la pestaña "Control de Costos" de Gerencia Técnica, limitándolos a los que tienen datos reales que los respalden (hoy, "Solo con desviación") y excluyendo un selector de categoría de gasto sin backend.
## Requirements
