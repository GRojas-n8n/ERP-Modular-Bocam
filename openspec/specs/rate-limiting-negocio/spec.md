# rate-limiting-negocio Specification

## Purpose

Paquete compartido de rate limiting (`packages/rate-limiter`), respaldado por
Redis con fallback automático a memoria, reusable por los microservicios de
negocio para responder 429 estandarizado cuando se excede el límite
configurado.
