# inmutabilidad-cuadro-comparativo-locked Specification

## Purpose

Garantizar, a nivel de base de datos (failsafe independiente del backend), que un cuadro comparativo (`cuadros_comparativos`, microservicio `compras`) en estado `LOCKED` sea inmutable — no se puede modificar ni borrar — mientras que un cuadro en cualquier otro estado sí puede borrarse normalmente.
