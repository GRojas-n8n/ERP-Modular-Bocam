# gestion-ciclo-vida-usuarios-admin Specification

## Purpose
Define cómo un administrador edita el correo de un usuario y lo archiva o reactiva desde Administración → Usuarios, incluyendo validación de formato, unicidad dentro del tenant y confirmación previa.
## Requirements
