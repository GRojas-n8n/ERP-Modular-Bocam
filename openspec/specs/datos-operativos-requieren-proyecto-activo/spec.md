# datos-operativos-requieren-proyecto-activo Specification

## Purpose

Garantiza que las rutas y vistas clasificadas como project-scoped no lean ni modifiquen datos cuando falta un proyecto activo y autorizado, incluso para roles de nivel tenant como `admin`. Los modos globales solo existen como excepciones declaradas por capacidad, con una matriz de alcance verificable. Surgió del hallazgo posterior a la purga de proyectos de prueba del 2026-09-24, cuando una cuenta sin proyectos pudo leer presupuestos del tenant en Gerencia Técnica.
