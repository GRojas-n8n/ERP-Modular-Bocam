# control-acceso-rol-finanzas-cambio-proyecto Specification

## Purpose

El cambio de proyecto activo en el microservicio `auth` reconoce al rol real `'finanzas'` (español) como rol global, igual que `'admin'`, `'superintendent'` y `'procurement'`, permitiendo a Finanzas cambiar de proyecto sin necesitar un registro de acceso explícito por proyecto.
