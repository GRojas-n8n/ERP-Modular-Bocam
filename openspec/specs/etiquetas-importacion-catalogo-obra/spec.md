# etiquetas-importacion-catalogo-obra Specification

## Purpose
Fija la etiqueta de los botones que importan el presupuesto exportado en "Catálogo de Obra" para que nombren lo que se importa (el catálogo de conceptos) y no el software de origen.
## Requirements
