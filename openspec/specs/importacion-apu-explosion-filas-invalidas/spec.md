# importacion-apu-explosion-filas-invalidas Specification

## Purpose
Evita errores 500 al importar archivos de APU y Explosión de Insumos: descarta filas de boilerplate por longitud implausible, valida límites de columna en la importación por lote y expone la causa real del error al usuario.
## Requirements
