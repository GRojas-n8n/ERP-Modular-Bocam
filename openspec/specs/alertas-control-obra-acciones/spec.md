# alertas-control-obra-acciones Specification

## Purpose
Define las acciones sobre alertas en la pestaña "Alertas" de Control de Obra: reconocer en un clic, reconocer con nota como acción secundaria e ignorar con justificación obligatoria.
## Requirements
