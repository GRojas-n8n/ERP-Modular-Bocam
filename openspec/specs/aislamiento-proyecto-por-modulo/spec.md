# aislamiento-proyecto-por-modulo Specification

## Purpose

Formaliza el patrón "Global con Trazabilidad" (`current_proyecto_id() IS NULL OR proyecto_id = current_proyecto_id()`) para las tablas de pago de Finanzas, y expone el `proyecto_id` de cada asignación activa de un empleado en el listado de Personal — de forma que un rol de nivel-tenant sin proyecto activo pueda consolidar datos de todo el tenant sin perder trazabilidad por proyecto.
