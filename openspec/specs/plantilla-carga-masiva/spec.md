# plantilla-carga-masiva Specification

## Purpose

Las pantallas con carga masiva (Proveedores, Empleados, Clientes) ofrecen un
botón "Descargar plantilla" junto al botón "Importar CSV/Excel", para que el
usuario conozca la estructura de columnas exacta que el importador reconoce
antes de intentar subir un archivo, sin tener que adivinarla o preguntarla.
