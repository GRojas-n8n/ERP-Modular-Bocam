...
- Colas nuevas con sufijo `.v2` solo para las suscripciones nuevas; las colas durables actuales no se tocan.
...
- `apps/almacen`: handler nuevo, columnas e índices de idempotencia, `/ready`, colas `.v2`.
