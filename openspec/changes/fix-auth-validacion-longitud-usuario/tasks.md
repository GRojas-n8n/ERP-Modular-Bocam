...
- [ ] 6.1 Desplegar vía CI (push a `main` tras PR aprobado).
- [ ] 6.2 Verificar en `iretum.com` que el alta/edición de usuario con un campo largo (p. ej. email) ya no produce el 500 crudo, y que un alta normal sigue funcionando.
- [ ] 6.3 `openspec archive fix-auth-validacion-longitud-usuario` tras verificación en producción.
