...
- [ ] 3.3 Verificación manual en navegador: con un usuario con acceso a 2+ proyectos, abrir
...
- [ ] 4.1 Sincronizar `openspec/specs/navegacion-multi-proyecto-compras/spec.md` (nuevo) al
      archivar.
