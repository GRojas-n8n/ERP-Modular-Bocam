...
- [ ] 2.5 Click en estimación → navegar a tab estimaciones (navegación inter-tab — DIFERIDO)
...
- [ ] 3.1 Con rol `residencia` en iretum.com: dashboard Residentes muestra panel personalizado
- [ ] 3.2 OCs por recibir se listan correctamente
- [ ] 3.3 Alerta de estimaciones pendientes aparece si hay estimaciones sin aprobar
