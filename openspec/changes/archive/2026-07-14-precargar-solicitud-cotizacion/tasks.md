...
- [x] 3.3 Verificación manual en navegador: marcar proveedores como respondidos, recargar la
      ...
      una Requisicion + SolicitudCotizacion reales (1 proveedor
      `RESPONDIO`) sembradas vía script Prisma de un solo uso (script y
      test borrados tras usarlos). Al cargar la vista de Requisiciones
      directamente (sin clic previo en "Ver Solicitud de Cotización"), el
      botón "Crear Cuadro Comparativo" ya está visible en la tarjeta.
