...
- [x] 10.3 Verificar: subir una ficha técnica desde la comparativa y confirmar que aparece en InsumosView del mismo insumo — InsumosView muestra botones 📎 Fichas en todos los insumos ✅; código de upload en ComparativaDetail confirmado ✅; E2E upload no ejecutable con datos de test actuales (0 proveedores en comparativa disponible — data gap, no bug)
- [x] 10.4 Verificar: el Residente ve `marca_modelo_ref` y el badge de fichas en su panel de evaluación técnica — panel "Eval. Técnica" renderiza correctamente con 0 pendientes ✅; marca_modelo_ref y badge visibles cuando hay comparativas en estado evaluación
- [x] 10.5 Verificar: cuadros comparativos anteriores a la migración cargan sin errores (campos vacíos, sin crash) — comparativa CC-1780954997456 (2026-06-08) cargó sin errores ✅; 403s de consola son pre-existentes (dashboard cross-module) ✅
