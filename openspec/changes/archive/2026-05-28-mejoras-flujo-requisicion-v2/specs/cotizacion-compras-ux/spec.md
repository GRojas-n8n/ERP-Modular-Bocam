# Spec: cotizacion-compras-ux

## Comportamiento esperado

El ciclo de cotización tiene 4 estados visibles en la tarjeta de requisición en ComprasView.
Procurement sabe siempre en qué paso está y qué acción le toca.
