...
| Specs canónicas | 163 | 102 | 61 |
| Total | 174 | 113 | 61 |

Cifras al 2026-09-25 tras el lote de archivo 3.1, la normalización `SHALL`/`MUST` y los lotes 1 a 6 de migración (medidas sobre el árbol versionado;
...
La deuda restante son las 61 specs sin `Purpose`/`Requirements` canónicos.
...
|---|---:|---|
| Spec sin `Purpose`/`Requirements` canónicos | 61 | migración estructural conservando literalmente requisitos y escenarios |
