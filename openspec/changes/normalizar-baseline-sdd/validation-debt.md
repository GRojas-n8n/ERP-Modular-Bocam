...
| Specs canónicas | 163 | 72 | 91 |
| Total | 174 | 83 | 91 |

Cifras al 2026-09-25 tras el lote de archivo 3.1, la normalización `SHALL`/`MUST` y el lote 1 de migración (medidas sobre el árbol versionado;
...
La deuda restante son las 91 specs sin `Purpose`/`Requirements` canónicos.
...
|---|---:|---|
| Spec sin `Purpose`/`Requirements` canónicos | 91 | migración estructural conservando literalmente requisitos y escenarios |
