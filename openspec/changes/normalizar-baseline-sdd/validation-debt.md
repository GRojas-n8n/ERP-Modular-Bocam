...
| Specs canónicas | 163 | 83 | 80 |
| Total | 174 | 94 | 80 |

Cifras al 2026-09-25 tras el lote de archivo 3.1, la normalización `SHALL`/`MUST` y los lotes 1 a 3 de migración (medidas sobre el árbol versionado;
...
La deuda restante son las 80 specs sin `Purpose`/`Requirements` canónicos.
...
|---|---:|---|
| Spec sin `Purpose`/`Requirements` canónicos | 80 | migración estructural conservando literalmente requisitos y escenarios |
